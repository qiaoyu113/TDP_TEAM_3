...
from RedTeamGoalkeeper import Goalkeeper
from RedTeamDefenderLeft import DefenderLeft
from RedTeamDefenderRight import DefenderRight
from RedTeamForward import Forward
