...
from BlueTeamGoalkeeper import Goalkeeper
from BlueTeamDefender import Defender
from BlueTeamLeftForward import ForwardLeft
from BlueTeamRightForward import ForwardRight
